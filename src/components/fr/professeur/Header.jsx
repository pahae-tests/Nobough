                ...
                <div className="container mx-auto flex justify-between items-center py-2 flex-col sm:flex-row" onClick={() => { setShowNotifications(false); setShowProfileMenu(false); setMobileMenuOpen(false) }}>
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="border-l-2 border-pink-400 pl-3">
                            ...
                            <p className="text-xs sm:text-sm text-pink-200">Espace Professeur</p>
                        </div>
                    </div>
                ...
                <div className="bg-white shadow-lg md:hidden z-50">
                    <ul className="flex flex-col">
                        {currentFormationID && (
                            <li>
                                <button
                                    className={`px-4 py-3 font-medium transition-all w-full text-left flex items-center justify-between ${activeTab === 'formation' ? 'bg-green-50 text-green-700' : 'hover:bg-gray-100'}`}
                                    onClick={() => handleTabChange('formation')}
                                >
                                    <div className="flex items-center">
                                        <PieChart className={`w-5 h-5 mr-2 ${activeTab === 'formation' ? 'text-green-600' : 'text-gray-500'}`} />
                                        <span>Récent</span>
                                    </div>
                    ...
                    <ul className="flex overflow-x-auto">
                        {currentFormationID &&
                            <li ref={recent} className='translate-y-20'>
                                <button
                                    className={`px-5 py-4 font-medium border-b-3 transition-all duration-200 flex items-center ${activeTab === 'formation' ? 'border-green-600 text-green-700 bg-green-50' : 'border-transparent hover:bg-gray-100'} cursor-pointer`}
                                    onClick={() => setActiveTab('formation')}
                                >
                                    <PieChart className={`w-5 h-5 ${activeTab === 'formation' ? 'text-green-600' : 'text-gray-500'}`} />
