    ...
    const inscriptionsFormations = [
        {
            ...
            birth: "15/03/1997",
            CIN: "AB123456",
            formationTitre: "Web Design",
            formationPrix: 150,
            dateInscr: "05/04/2025"
        },
        {
            id: 2,
            img: "/user.jpg",
            ...
            birth: "22/09/1996",
            CIN: "CD789012",
            formationTitre: "Fiqh Ibno Achir",
            formationPrix: 100,
            dateInscr: "08/04/2025"
        }
    ]

    const paiementsFormations = [
        {
            id: 1,
            img: "/user.jpg",
            nom: "test",
            ...
            message: "Voici mon paiement pour le premier mois de formation",
            montant: 150,
            datePaiement: "11/04/2025"
        }
    ]
                ...
                {activeTab === 'inscriptions' && (
                    <div className="bg-white/60 backdrop-blur-xs p-6 rounded-xl shadow-xl mb-6">
                        <h2 className="text-2xl font-bold mb-6 flex items-center">
                            ...
                            Inscriptions aux formations ({inscriptionsFormations.length})
                        </h2>

                        <div className="space-y-4">
                            {inscriptionsFormations.map((inscription) => (
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-pink-50 p-3 rounded-lg border border-pink-100">
                                                    <div className="flex items-center mb-2">
                                                        <Book className="w-5 h-5 text-pink-600 mr-2" />
                                                        <h5 className="font-semibold text-pink-600">{inscription.formationTitre}</h5>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                                        <div className="col-span-2 flex items-center">
                                                            <DollarSign className="w-4 h-4 text-pink-500 mr-2" />
                                                            <span className="font-medium">Prix:</span>
                                                            <span className="ml-2">{inscription.formationPrix}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                {activeTab === 'paiements' && (
                    <div className="bg-white/60 backdrop-blur-xs p-6 rounded-xl shadow-xl mb-6">
                        <h2 className="text-2xl font-bold mb-6 flex items-center">
                            ...
                            Paiements du premier mois ({paiementsFormations.length})
                        </h2>

                        <div className="space-y-4">
                            {paiementsFormations.map((paiement) => (
                                        ...
                                        <div className="flex mb-4 sm:mb-0">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center mt-1">
                                                    ...
                                                    <span className="font-medium text-pink-600">{paiement.montant} DH</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                        ...
                                        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-pink-50 p-3 rounded-lg border border-pink-100">
                                                    <div className="flex items-center mb-2">
                                                        <Book className="w-5 h-5 text-pink-600 mr-2" />
                                                        <h5 className="font-semibold text-pink-600">{paiement.formationTitre}</h5>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                                        <div className="col-span-2 flex items-center">
                                                            <DollarSign className="w-4 h-4 text-pink-500 mr-2" />
                                                            <span className="font-medium">Prix:</span>
                                                            <span className="ml-2">{paiement.formationPrix}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
